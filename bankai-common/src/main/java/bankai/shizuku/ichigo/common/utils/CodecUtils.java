...
import bankai.shizuku.ichigo.common.constant.CommonConstant;
...
public class CodecUtils {
    ...
    public static String urlEncode(String url) {
        try {
            return URL_CODEC.encode(url, CommonConstant.CHARSET.CHARSET_UTF8);
    ...
    public static String urlDecode(String url) {
        try {
            return URL_CODEC.decode(url, CommonConstant.CHARSET.CHARSET_UTF8);
